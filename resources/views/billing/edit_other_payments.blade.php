            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('/')}}/billings/edit-other-payments/{{$Other->id}}" method="POST" id="other-Payments" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" name="amount" value="{{$Other->amount}}" autocomplete="off" value="" class="form-control" placeholder="" required>
                                            </div>
                                        </div>
                                    </div>
                                    {{--  --}}
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea rows="3" cols="3" class="form-control" placeholder="Default textarea" name="description" required>{{$Other->description}}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="text-right">
                                    ...
                                    <p id="Success" style="padding:10px" class="alert-success">Changes Have Been Saved Successfully</p>
                                </div>
