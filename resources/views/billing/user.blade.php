            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('/')}}/billings/save-user/{{$User->id}}" method="POST" id="Enroll-Form" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-lg-12">
                                        {{--  --}}
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" name="name" value="{{$User->name}}" id="student-name-1265" placeholder="Full Name" autocomplete="student-name">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="email" onblur="duplicateEmail(this)" name="email" value="{{$User->email}}" autocomplete="off" class="form-control" placeholder="name@domain.com">
                                ...
                                <div class="text-right">
                                    ...
                                    <p id="Success" style="padding:10px" class="alert-success">User Has Been Updated</p>
                                </div>
