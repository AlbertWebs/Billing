            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('/')}}/billings/edit-bill/{{$bill->id}}" method="POST" id="Enroll-Forms" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group" data-select2-id="207">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" class="form-control" readonly name="reference"  placeholder="Computer Technology" value="Correction-Label-{{$bill->original_payment}}" autocomplete="student-name" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="form-group" data-select2-id="207">
                                                            <select name="user" class="form-control select-minimum select2-hidden-accessible" data-fouc="" data-select2-id="66" tabindex="-1" aria-hidden="true" required>
                                                                <optgroup label="Students" data-select2-id="208">
                                                                    ...
                                                                    <?php $Studs = DB::table('students')->where('id',$bill->student)->get(); ?>
                                        ...
                                        <hr>
                                        <input type="hidden" name="initial_value" value="{{$bill->amount}}">
                                        <div class="col-lg-12">
                                            <div class="form-group" data-select2-id="207">
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Amount:</label>
                                                    <div class="col-lg-10">
                                                        <input type="number" class="form-control" name="amount" value="{{$bill->amount}}" placeholder="10000" autocomplete="student-name" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="form-group" data-select2-id="207">
                                                            <select name="course" class="form-control select-search select2-hidden-accessible" data-fouc="" data-select2-id="66" tabindex="-1" aria-hidden="true" required>
                                                                <optgroup label="Courses" data-select2-id="208">
                                                                    ...
                                                                    @foreach ($Studs as $studs)
                                                                        <?php $collection = DB::table('courses')->where('id',$bill->course_id)->get(); ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <textarea rows="3" cols="3" class="form-control" placeholder="Default textarea" name="description" required>Fee Payment - Entry Correction</textarea>
                                            </div>
                                        </div>
                                        <hr>
