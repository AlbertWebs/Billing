                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-lg-300">
                    ...
                    <div class="dropdown-content-body dropdown-scrollable">
                        <ul class="media-list">
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('theme/assets/global_assets/images/demo/users/face18.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('theme/assets/global_assets/images/demo/users/face24.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('theme/assets/global_assets/images/demo/users/face17.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('theme/assets/global_assets/images/demo/users/face19.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <div class="mr-3">
                                    <img src="{{asset('theme/assets/global_assets/images/demo/users/face16.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                                </div>
                                <div class="media-body">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-lg-350">
                ...
                <div class="dropdown-content-body dropdown-scrollable">
                    <ul class="media-list">
                        ...
                        <li class="media">
                            <div class="mr-3 position-relative">
                                <img src="{{asset('theme/assets/global_assets/images/demo/users/face3.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                            </div>
                        ...
                        <li class="media">
                            <div class="mr-3">
                                <img src="{{asset('theme/assets/global_assets/images/demo/users/face4.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                            </div>
                            <div class="media-body">
                                <div class="media-title">
                                    <a href="#">
                        ...
                        <li class="media">
                            <div class="mr-3">
                                <img src="{{asset('theme/assets/global_assets/images/demo/users/face25.jpg')}}" width="36" height="36" class="rounded-circle" alt="">
                            </div>
                            <div class="media-body">
                                <div class="media-title">
                                    <a href="#">
