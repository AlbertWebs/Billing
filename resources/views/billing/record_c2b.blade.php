            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('/')}}/billings/create-bill-c2b" method="POST" id="Enroll-Forms" enctype="multipart/form-data">
                                {{csrf_field()}}
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group" data-select2-id="207">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="text" class="form-control" name="transID"  placeholder="10000" autocomplete="student-name" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="text-right">
                                    ...
                                    @else
                                    <button onclick="return confirm('Proceed with this Transaction? You cannot undo this process')" type="submit" class="btn btn-primary">
