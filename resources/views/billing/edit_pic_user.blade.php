        ...
        <div class="page-header page-header-light">
            <div class="page-header-content header-elements-lg-inline">
                <div class="page-title d-flex">
                    <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Update Avatar : {{$User->name}}</span></h4>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('/')}}/billings/save-pic-user/{{$User->id}}" method="POST" id="Enroll-Forms" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <hr>

                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <center><img style="border-radius:50%; border:10px solid #000000;" width="250" src="{{url('/')}}/uploads/users/{{$User->avatar}}"></center>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <input type="hidden" name="retained" value="{{$User->avatar}}">
                            </form>
                        </div>
                    </div>
                    <!-- /basic layout -->
