                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{url('/')}}/billings/save-settings-single/{{$Setting->id}}" method="POST" id="Enroll-Forms" enctype="multipart/form-data">
                                {{csrf_field()}}
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group" data-select2-id="207">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" name="initial"  placeholder="Atlas Educational Center" value="{{$Setting->aka}}" autocomplete="student-name" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
